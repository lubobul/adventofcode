...
toggle 296,687 through 906,775";
        ...
        public static bool[,] grid1 = new bool[1000,1000];
        public static int[,] grid2 = new int[1000, 1000];
        ...
        class Command
        {
            ...
            public void Parse(string command)
            {
                ...
                {
                    command = command.Substring(9, command.Length - 9);
                    CommandType = Type.Off;
                }

                string[] coordinateStrings = command.Split(" through ");

                var X0Y0 = coordinateStrings[0].Split(',');
                var X1Y1 = coordinateStrings[1].Split(',');
        ...
        {
            List<string> inputList = input.Split(new[] { Environment.NewLine }, StringSplitOptions.None).Select(word => word.Trim()).ToList();

            foreach (var stringCommand in inputList)
            {
