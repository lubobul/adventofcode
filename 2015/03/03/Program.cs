...
namespace _03
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            visitedHouses.Add(new House { X = 0, Y = 0 });

            var prevHouseSanta = new House { X = 0, Y = 0 };
            var prevHouseRobo = new House { X = 0, Y = 0 };
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                var prevHouse = prevHouseSanta;

                if(i%2 == 1)
                {
                    prevHouse = prevHouseRobo;
                }
                ...
                if(!visitedHouses.Any(house => house.X == prevHouse.X && house.Y == prevHouse.Y))
                {
                    visitedHouses.Add(new House {
                        X = prevHouse.X,
                        Y = prevHouse.Y
                    });
